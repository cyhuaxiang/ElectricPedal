...
void interrupt high_priority High_ISR(void)
{
	...
	{
        /*右边门检测*/
        if(((g_tCanRxMsg.Data[5]&BIT0) == 0) || ((g_tCanRxMsg.Data[5]&BIT2) == 0))
        {
            SysRunData.PedalRunFlag |= (1<<1);
        }
        else 
        {
            SysRunData.PedalRunFlag &= ~(1<<1);
        ...
        /*左边门检测*/
        if(((g_tCanRxMsg.Data[5]&BIT1) == 0) || ((g_tCanRxMsg.Data[5]&BIT3) == 0))
        {
            SysRunData.PedalRunFlag |= (1<<0);
        }
        else 
        {
            SysRunData.PedalRunFlag &= ~(1<<0);
	...
	{
        /*右边门检测*/
        if(((g_tCanRxMsg.Data[1]&BIT6) == BIT6) || ((g_tCanRxMsg.Data[2]&BIT2) == BIT2))
        {
            SysRunData.PedalRunFlag |= (1<<1);//右踏板动作   
        }
        else 
        {
            SysRunData.PedalRunFlag &= ~(1<<1);
        ...
        /*左边门检测*/
        if(((g_tCanRxMsg.Data[2]&BIT1) == BIT1) || ((g_tCanRxMsg.Data[2]&BIT3) == BIT3))
        {
            SysRunData.PedalRunFlag |= (1<<0);//左踏板动作
        }
        else 
        {
            SysRunData.PedalRunFlag &= ~(1<<0);   
