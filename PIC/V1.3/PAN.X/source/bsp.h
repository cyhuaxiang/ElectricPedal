...
// get/set REMOTE_EN aliases
#define REMOTE_EN_TRIS               TRISA5
#define REMOTE_EN_LAT                LATA5
#define REMOTE_EN_PORT               RA5
#define REMOTE_EN_WPU                WPUA5
#define REMOTE_EN_ANS                ANSA5
#define REMOTE_EN_SetHigh()    do { LATA5 = 1; } while(0)
#define REMOTE_EN_SetLow()   do { LATA5 = 0; } while(0)
#define REMOTE_EN_Toggle()   do { LATA5 = ~LATA5; } while(0)
#define REMOTE_EN_GetValue()         RA5
#define REMOTE_EN_SetDigitalInput()    do { TRISA5 = 1; } while(0)
#define REMOTE_EN_SetDigitalOutput()   do { TRISA5 = 0; } while(0)

#define REMOTE_EN_SetPullup()    do { WPUA5 = 1; } while(0)
#define REMOTE_EN_ResetPullup()   do { WPUA5 = 0; } while(0)
#define REMOTE_EN_SetAnalogMode()   do { ANSA5 = 1; } while(0)
#define REMOTE_EN_SetDigitalMode()   do { ANSA5 = 0; } while(0)
// get/set REMOTE_IN aliases
#define REMOTE_IN_TRIS               TRISB4
#define REMOTE_IN_LAT                LATB4
#define REMOTE_IN_PORT               RB4
#define REMOTE_IN_WPU                WPUB4
#define REMOTE_IN_ANS                ANSB4
#define REMOTE_IN_SetHigh()    do { LATB4 = 1; } while(0)
#define REMOTE_IN_SetLow()   do { LATB4 = 0; } while(0)
#define REMOTE_IN_Toggle()   do { LATB4 = ~LATB4; } while(0)
#define REMOTE_IN_GetValue()         PORTBbits.RB4//RB4
#define REMOTE_IN_SetDigitalInput()    do { TRISB4 = 1; } while(0)
#define REMOTE_IN_SetDigitalOutput()   do { TRISB4 = 0; } while(0)

#define REMOTE_IN_SetPullup()    do { WPUB4 = 1; } while(0)
#define REMOTE_IN_ResetPullup()   do { WPUB4 = 0; } while(0)
#define REMOTE_IN_SetAnalogMode()   do { ANSB4 = 1; } while(0)
#define REMOTE_IN_SetDigitalMode()   do { ANSB4 = 0; } while(0)
